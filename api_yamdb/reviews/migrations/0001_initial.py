# Generated by Django 3.2 on 2023-07-08 15:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmation_code', models.UUIDField(default='ed102732-143a-4133-a52b-d850d1eac6a1')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Слаг для страницы с жанром может содержать только латинские буквы и любые цифры, а также дефис и нижнее подчеркивание', regex='^[-a-zA-Z0-9_]+$')], verbose_name='Адрес для страницы с категорией')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Слаг для страницы с жанром может содержать только латинские буквы и любые цифры, а также дефис и нижнее подчеркивание', regex='^[-a-zA-Z0-9_]+$')], verbose_name='Адрес для страницы с жанром')),
            ],
            options={
                'verbose_name': 'Жанр',
